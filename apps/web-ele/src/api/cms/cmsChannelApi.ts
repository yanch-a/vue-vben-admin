...
const urlPre = adminUrl + '/lmcms/cmsChannelManage/'
...
export function getAllTree(params: any) {
  return request({
    url: urlPre + 'getAllTree',
    method: 'get',
    params,
  })
}
...
export function getChannelsWithExtByParentId(parentId: number) {
  return request({
